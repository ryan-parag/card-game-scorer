...
export default function NumberInput({ value = 10, min = 1, max = Infinity, onChange }: Props) {
	...
	return (
		<div className="group inline-flex items-stretch rounded-md text-3xl font-semibold ring ring-stone-400 dark:ring-stone-600 transition-[box-shadow] focus-within:ring-2 focus-within:ring-stone-500">
			<button
				aria-hidden="true"
				tabIndex={-1}
				className="flex items-center pl-[.5em] pr-[.325em] transform active:scale-95 hover:bg-black/5 dark:hover:bg-white/5"
			...
			<button
				aria-hidden="true"
				tabIndex={-1}
				className="flex items-center pl-[.325em] pr-[.5em] transform active:scale-95 hover:bg-black/5 dark:hover:bg-white/5"
