          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="flex-wrap items-center gap-x-1 gap-y-1 pt-1 text-sm flex">
                <span className="text-muted-foreground hidden lg:inline-block">Common games:</span>
                {['Uno Golf', 'Rummy', 'Spades', 'Screw the Dealer'].map((gameName) => (
                  <button
                    key={gameName}
                    onClick={() => setGameName(gameName)}
                    className="transition ml-1 text-sm px-2 py-0.5 rounded-md bg-transparent border border-input text-muted-foreground hover:bg-muted hover:text-foreground transform active:scale-[97%] active:shadow-inner"
                  >
                    {gameName}
                  </button>
                ))}
            ...
            <div>
              ...
              {
                showMoreRounds ? (
                  <div className="mt-4 p-2 rounded-lg bg-foreground/5 flex justify-center text-center text-sm text-muted-foreground">
                ...
                (
                  <div className="mt-2 flex justify-center">
                    <Button
                        variant="ghost"
                        size={'sm'}
                        className="text-sm px-2 py-px rounded-sm hover:bg-muted hover:underline opacity-60 hover:opacity-100 transition font-normal transform active:scale-[97%] active:shadow-inner"
